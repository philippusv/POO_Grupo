...
public class JMenuPresidente extends JFrame {
	...
	public JMenuPresidente(Pessoas pessoa) {
		...
		comboBoxRelatorio.setModel(
				new DefaultComboBoxModel(new String[] { "Selecione uma opção ", "Diretor", "Capital Armazenado" }));
		...
		comboBoxCadastro.setModel(
				new DefaultComboBoxModel(new String[] { "Selecione uma opção ", "Cliente", "Gerente", "Diretor" }));
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (opcao.equalsIgnoreCase(PessoaEnum.CLIENTE.getTipoPessoa())) {
					...
					dispose();
					JCadastroDiretor cd = new JCadastroDiretor(pessoa, "Diretor");
